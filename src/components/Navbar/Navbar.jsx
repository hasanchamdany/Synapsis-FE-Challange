          ...
          <div>
            <div className="flex items-center justify-between py-1 md:py-2 md:block">
              <Link href="/" passHref className='flex'>
                ...
                <h2 className="flex items-center text-2xl text-n-blue font-bold font-poppins">Gorest</h2>
              </Link>
            ...
            >
              <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                <li className="text-n-blue">
                  <Link href="/post-list">
                    <div className="font-poppins font-semibold ">Post List</div>
                  </Link>
                </li>
                <li className="text-n-blue">
                  <Link href="/blog-posts">
                    <div className="font-poppins font-semibold ">Blog Posts</div>
                  </Link>
                </li>
                <li className="text-n-blue">
                  <Link href="/user-dashboard">
                    <div className="font-poppins font-semibold ">Users Dashboard</div>
                  </Link>
                </li>
