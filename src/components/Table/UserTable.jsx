...
const UserTable = () => {
  ...
  console.log(data);
  return (
    <div class="container max-w-7xl mx-auto xl:pt-36 pt-20">
      <div class="mb-4">
        <h1 class="font-serif text-3xl font-bold text-white decoration-gray-400">
          {" "}
          User Dashboard
        </h1>
                  ...
                  return (
                    <tr key={datas.id}>
                      <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                        <div class="flex items-center">{datas.id}</div>
                      </td>
